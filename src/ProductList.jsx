...
function ProductList({ onHomeClick }) {
                ...
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)}>
                            <div>
                                <h3 style={{ color: 'white' }}>Artems Green Garden</h3>
  ...
  <div>
    <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
      <h1 className='cart' style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}>
        ...
        <span>{useSelector((s) => s.cart.items).reduce((t, i) => t + i.quantity, 0)}</span>
      </h1>
    </a>
  </div>
</div>
