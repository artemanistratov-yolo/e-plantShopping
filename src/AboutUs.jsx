...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Artems Garden Shop, where green meets serenity!</p>
      <p className="about-us-content">
        At Artems Garden Shop, we are passionate about bringing nature closer to you.
         Our mission is to offer a wide variety of high-quality plants that not only beautify your surroundings but also support a healthier and more sustainable lifestyle. 
         From air-purifying greenery to wonderfully fragrant plants, we have something special for every plant lover.
      </p>
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Artems Garden Shop today and experience the 
